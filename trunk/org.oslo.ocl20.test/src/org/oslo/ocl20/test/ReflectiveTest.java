...
//			URI fileURI = URI.createFileURI("E:\\Models\\company.ecore");
	...
	public void testReflectiveModel()
	{
		loadsources();
		System.out.println();
		...
		l = processor.evaluate_2("context SLSystem inv: self.oclIsTypeOf(SLSystem)",env,renv,log);
		o = l.get(0);
		...
		l = processor.evaluate_2("context SLSystem inv: self.oclIsKindOf(ASDElement)",env,renv,log);
		o = l.get(0);
		assertTrue(o.toString().equals("true"));
		System.out.println(l);
		
		System.out.print("Test ReflectiveModel: context SLSystem inv: theBlockToSystem->size() - must be 5 and is ");
		l = processor.evaluate_2("context SLSystem inv: theBlockToSystem->size()",env,renv,log);
		o = l.get(0);
		...
		l = processor.evaluate_2("context SLSystem inv: SLBlock.allInstances()->forAll(x|x.oclIsTypeOf(SLBlock))",env,renv,log);
		o = l.get(0);
		assertTrue(o.toString().equals("false"));
		System.out.println(l);
